...
//#define USE_MODERN_OPTIONS		// !!!!! DELETE CONFIG.WL6 AFTER CHANGING !!!!! - Enables Modern Control Scheme
//#define SHOW_ADVANCED_CONTROLS	// !!!!! DELETE CONFIG.WL6 AFTER CHANGING !!!!! - Needs #USE_MODERN_OPTIONS flag enabled and code tweaks to customize the keys. See documentation for explanation.	
