...
#define SD_SoundPlaying() 0 // TODO REVIEW
#define UNCACHEAUDIOCHUNK(chunk) ASM_Uncache(ASM_Audiosegs[chunk]);
#define SD_WaitSoundDone() //TODO REVIEW
#define SD_PrepareSound(which) int nullps = which //TODO REVIEW
...
#define SD_ContinueMusic(chunk, startoffs) SD_StartMusic(chunk) //TODO REVIEW
